...
* convert audio caption strips to text strips for hardcoded/open caption creation
* convert batch audio caption strips to text strips based on template strip to control formatting
